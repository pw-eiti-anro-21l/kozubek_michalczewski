...
class MinimalPublisherSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.i = 0
        self.x = 0
        self.get_logger().info('Press ' + self.get_parameter('foward_key').get_parameter_value().string_value + ' to move fowrd, ' + self.get_parameter('backward_key').get_parameter_value().string_value + ' to move backward, and press ' + self.get_parameter('left_key').get_parameter_value().string_value + ' and ' + self.get_parameter('right_key').get_parameter_value().string_value + ' to move left and right')
